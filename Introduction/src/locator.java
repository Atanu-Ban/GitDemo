...
public class locator {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//This code for unable to establish websocket connection
				...
				//driver.findElement(By.xpath("//*[@class=\"p-dropdown-filter p-inputtext p-component ng-tns-c277-3\"]")).sendKeys("CREOKS");
				Thread.sleep(1000);
				driver.findElement(By.xpath("//li[@class=\"p-ripple p-element p-dropdown-item\"]")).click();
				
				//Handiling Radio Button
				
				driver.findElement(By.xpath("(//*[@class=\"p-radiobutton-box\"])[1]")).click();
			
				
				//Handiling Dynamic Dropdown

				//Click on the Dropdown
				driver.findElement(By.xpath("//*[@class=\"p-dropdown-trigger ng-tns-c277-4\"]")).click();
				driver.findElement(By.xpath("//*[@class=\"p-dropdown-filter p-inputtext p-component ng-tns-c277-4\"]")).sendKeys("School System");
				Thread.sleep(2000);
				driver.findElement(By.xpath("(//li[@class=\"p-ripple p-element p-dropdown-item p-highlight\"])[1]")).click();
